...
public enum ChartType {
  ...
  ACTIVIY_COLUMN("アクテビティ別ユーザー頻度分布", 2, 1000, 600, ItemType.ACTIVITIES),
  ACTIVITY_CALENDAR("日付別＋１数分布", 2, 1400, 700, ItemType.ACTIVITIES),
  NUM_OF_PLUSONE("ユーザー頻度別＋１数", 1, 700, 700, ItemType.ACTIVITIES),
  PLUSONRES_PIE("＋１ユーザー頻度分布", 1, 700, 700, ItemType.PLUSONERS),
