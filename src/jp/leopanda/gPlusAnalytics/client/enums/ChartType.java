...
public enum ChartType {
  ...
  ACTIVIY_COLUMN("アクテビティ毎リピーター分布", 2, 1000, 600, ItemType.ACTIVITIES),
  ACTIVIY_LINE("リピーター比率トレンド", 2, 1000, 600, ItemType.ACTIVITIES),
  ACTIVITY_CALENDAR("日付別＋１数分布", 2, 1400, 700, ItemType.ACTIVITIES),
  NUM_OF_PLUSONE("リピーター別＋１数比率", 1, 700, 700, ItemType.ACTIVITIES),
  PLUSONRES_PIE("リピーター数比率", 1, 700, 700, ItemType.PLUSONERS),
