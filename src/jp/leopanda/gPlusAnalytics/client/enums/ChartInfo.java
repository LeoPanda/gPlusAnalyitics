...
import jp.leopanda.gPlusAnalytics.client.chart.GenderPieChart;
import jp.leopanda.gPlusAnalytics.client.chart.LanguagePieChart;
...
public enum ChartInfo {
	...
	ACTIVITY_CALENDAR("日付別＋１数分布", 2, 1400, 700),
